...
/**
 * Transforms Amonatbonk API response to the standard product format.
 *
 * Amonatbonk API endpoint: /api/v1/products/all/
 * Auth: x-api-key header
 * Base URL: https://products.amonatbonk.tj/api/v1
 */
class AmonatbonkTransformer
{
  /**
  ...
  /**
   * Build a single product from Amonatbonk data.
   *
