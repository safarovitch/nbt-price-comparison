...
/**
 * Transforms ICB (International Commercial Bank) API response to the standard product format.
 *
 * ICB API endpoint: /api/icb/products?type={type}&client_type={client_type}
 * Auth: Bearer token
 * Base URL: https://admin.icb.tj/api/icb
 *
 * Supports query parameters:
 *   type: transfer, credit, deposit, card
 *   client_type: legal, ind, entrepreneur
 *
 * Headers:
 *   Accept: application/json
 *   accept-language: ru|en|tj
 */
class IcbTransformer
{
  /**
  ...
  /**
   * Build a single product from ICB data.
   *
