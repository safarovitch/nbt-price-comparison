...
/**
 * Transforms MDO OXUS API response to the standard product format.
 *
 * OXUS API endpoint: /webhook/v1/products
 * Auth: x-api-key header
 * Base URL: https://n8n-lolcfinance-n8n.ov4co6.easypanel.host/webhook/v1
 *
 * Response: JSON array of products
 */
class OxusTransformer
{
  /**
