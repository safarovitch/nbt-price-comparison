...
/**
 * Transforms Sanoatsodirotbonk API response to the standard product format.
 *
 * Sanoatsodirotbonk API endpoint: /front/test/info/products
 * Auth: none
 * Base URL: http://109.74.66.233:8082/front/test/info
 */
class SanoatsodirotbonkTransformer
{
  /**
